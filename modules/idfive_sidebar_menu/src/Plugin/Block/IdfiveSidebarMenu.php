...
namespace Drupal\idfive_sidebar_menu\Plugin\Block;
...
/**
 * Idfive Sidebar Menu Block.
 *
 * @Block(
 *   id = "idfive_sidebar_menu",
 *   admin_label = @Translation("idfive Sidebar Menu Block")
 * )
 */
class IdfiveSidebarMenu extends BlockBase {
  ...
  public function build() {
    ...
    $menu['#theme'] = 'idfive_sidebar_menu__main';
